...
public class Eng implements Listener {
    ...
    public static final List<String> ITEM_LORE_REPLACEBLOCK_SETTING_USE_AIR = Arrays.asList(
            "§7If §6true§8: §bAir §7willbe §oused §7as a default block",
            "§7If §6false§8: §eNo item §8/ §eair §7will §cnot §7be §oplaced §7if held§8.");

    public static String INV_TITLE_SNEAKREPLACE_SETTINGS = "§7Sneak§bReplace §8§l- §cSettings",
            SPACE = " §0 ",
            UP_SPACE = " §0 \n §0 \n §0 ",
            LINE_SPACE = "§8§m§l------------------------",
            ITEM_NAME_REPLACEBLOCK_SETTING_USE_AIR = "§cAllow Air",
            ...
            SYSOUT_SERVER_STOPP = PRE + "The server stopp was triggered by ",
            ...
            CMD_STOP_SERVER_TR_ALREADY = PRE + "The §6server §cstopp §7was §6triggered §7already§8.",
            ...
            CMD_REPLACEBLOCK_TIMER_UPDATED = PRE + "Your §bReplace§8-§bBlock §2timer §7was §oupdated §7to §6";
